...
function SignupForm() {
    ...
    const [credential, setCredential] = useState({ name: "", username: "", password: "", imgURL:"" });
            ...
            <div className='my-52'>
                ...
                <div className="lg:w-2/6 lg:m-auto md:w-1/2 md:m-auto bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-3/4 m-auto mt-10 md:mt-0">
                    ...
                    <div className="relative mb-4">
                        ...
                        <input minLength="1" required={true} onChange={changeCred} type="text" value={credential.name} id="name" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    {/* //username */}
                    <div className="relative mb-4">
                    ...
                    {/* //imgURL */}
                    <div className="relative mb-4">
                        <label htmlFor="imgURL" className="leading-7 text-sm text-gray-600">Profile Picture URL</label>
                        <input minLength="1" required={true} onChange={changeCred} type="text" id="imgURL" value={credential.imgURL} name="imgURL" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    {/* //password */}
                    <div className="relative mb-4">
                    ...
                    <button onClick={submit} className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign Up</button>
                </div>
            </div>
            <ToastContainer />
        </div>
